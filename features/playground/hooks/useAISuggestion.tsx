...
const aiFeatureAvailable = isAIEnabled();
...
export const useAISuggestions = (): UseAISuggestionsReturn => {
  ...
  const fetchSuggestion = useCallback(async (type: string, editor: any) => {
    if (!aiFeatureAvailable || !state.isEnabled) {
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        console.warn("AI suggestion request failed:", response.status, response.statusText);
  ...
  return {
    ...state,
    isAvailable: aiFeatureAvailable,
    setEnabled,
    toggleEnabled,
    fetchSuggestion,
    acceptSuggestion,
