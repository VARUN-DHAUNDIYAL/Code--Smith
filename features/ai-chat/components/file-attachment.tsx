          ...
          <div className="flex items-center justify-between p-6">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 border rounded-full flex flex-col justify-center items-center">
                <Image src={"/logo.svg.png"} alt="Logo" width={28} height={28} />
              </div>
              <div>
                <h2 className="text-lg font-semibold text-zinc-100">PromptSmith AI Assistant</h2>
            ...
            {messages.length === 0 && !isLoading && (
              <div className="text-center text-zinc-500 py-16">
                <div className="relative w-16 h-16 border rounded-full flex flex-col justify-center items-center mx-auto mb-4">
                  <Image src={"/logo.svg.png"} alt="Logo" width={32} height={32} />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-zinc-300">PromptSmith AI Assistant</h3>
